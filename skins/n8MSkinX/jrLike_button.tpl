    ...
    <div id="{$module_url}_{$item._item_id}_{$action}" class="like_button_box">
        ...
        {if $like_status == 'like'}
            ...
            {if $_conf.jrLike_require_login == 'on' && !jrUser_is_logged_in()}
                ...
                <a href="{$jamroom_url}/{$uurl}/login">{jrCore_image  skin="n8Maestro4" image="like.png" width="24" height="24" class="like_button_img" alt=$title title=$title}</a>
            {else}
                <a onclick="jrLike_action('{$module_url}', '{$item._item_id}', 'like', '{$unique_id}');">{jrCore_image  skin="n8Maestro4" image="like.png" width="24" height="24" class="like_button_img" alt=$title title=$title}</a>
            {/if}
        ...
        {elseif $like_status == 'liked'}
            ...
            {if $_conf.jrLike_require_login == 'on' && !jrUser_is_logged_in()}
                {jrCore_module_url module="jrUser" assign="uurl"}
                <a href="{$jamroom_url}/{$uurl}/login">{jrCore_image  skin="n8Maestro4" image="liked.png" width="24" height="24" class="like_button_img" alt=$title title=$title}</a>
            {else}
                <a onclick="jrLike_action('{$module_url}', '{$item._item_id}', 'like', '{$unique_id}');">{jrCore_image  skin="n8Maestro4" image="liked.png" width="24" height="24" class="like_button_img" alt=$title title=$title}</a>
            {/if}
        ...
        {else}
            ...
            {jrCore_lang module="jrLike" id="4" default="Like" assign="title"}
            <a onclick="jrLike_action('{$module_url}', '{$item._item_id}', 'like', '{$unique_id}');">{jrCore_image  skin="n8Maestro4" image="`$like_status`.png" width="24" height="24" class="like_button_img" alt=$title title=$title}</a>
        {/if}
...
{elseif $action == 'dislike'}
    <div id="{$module_url}_{$item._item_id}_{$action}" class="dislike_button_box">
        ...
        {if $dislike_status == 'dislike'}
            ...
            {if $_conf.jrLike_require_login == 'on' && !jrUser_is_logged_in()}
                {jrCore_module_url module="jrUser" assign="uurl"}
                <a href="{$jamroom_url}/{$uurl}/login">{jrCore_image  skin="n8Maestro4" image="`$dislike_status`.png" width="24" height="24" class="dislike_button_img" alt=$title title=$title}</a>
            {else}
                <a onclick="jrLike_action('{$module_url}', '{$item._item_id}', 'dislike', '{$unique_id}');">{jrCore_image  skin="n8Maestro4" image="`$dislike_status`.png" width="24" height="24" class="dislike_button_img" alt=$title title=$title}</a>
            {/if}
        ...
        {else}
            ...
            <a onclick="jrLike_action('{$module_url}', '{$item._item_id}', 'dislike', '{$unique_id}');">
                {jrCore_image  skin="n8Maestro4" image="`$dislike_status`.png" width="24" height="24" class="dislike_button_img" alt=$title title=$title}</a>
        {/if}

...
$(document).ready(function(){
    ...
    var autoPlayCookie = jrReadCookie('n8Player_audio_autoplay');
    ...
    $('#jp_container_{$uniqid} #jp-auto-play').click(function() {
        jrSetCookie('n8Player_audio_autoplay', 0, 31);
        if ($(this).is(':checked')) {
            jrSetCookie('n8Player_audio_autoplay', 1, 31);
        }
    });
});
</script>

<div class="n8Player_player audio" onclick="event.cancelBubble = true; if(event.stopPropagation) event.stopPropagation();">
                            ...
                            <ul class="jp-toggles">
                                <li><a class="jp-settings" tabindex="1"></a>
                                    <div class="jp-control-settings" style="display: none;">
                                        <ul>
                                            <input type="checkbox" id="jp-show" /> <span>{jrCore_lang skin=$_conf.jrCore_active_skin id="114" default="Show Playlist"}</span><br>
                                        </ul>
                                    </div>
                                </li>
                            </ul>

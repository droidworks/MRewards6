        ...
        <ul id="menu">
            ...
            {if jrUser_is_master()}
                ...
                <li class="desk right">
                    <a href="{$jamroom_url}/{$core_url}/admin">
                        <img title="{jrCore_lang skin=$_conf.jrCore_active_skin id="69" default="ACP"}" alt="{jrCore_lang skin=$_conf.jrCore_active_skin id="69" default="ACP"}" src="{$jamroom_url}/skins/n8MSkinX/img/acp.png" />
                    </a>
                    <ul>
                        <li>
            ...
            {elseif jrUser_is_admin()}
                <a href="{$jamroom_url}/{jrCore_module_url module="jrCore"}/dashboard">
                    <img title="{jrCore_lang skin=$_conf.jrCore_active_skin id="68" default="dashboard"}" alt="{jrCore_lang skin=$_conf.jrCore_active_skin id="68" default="dashboard"}" src="{$jamroom_url}/skins/n8MSkinX/img/acp.png" />
                </a>
            {/if}

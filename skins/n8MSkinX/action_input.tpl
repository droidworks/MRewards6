<div class="box">
    {n8MSkinX_sort template="sort_index.tpl" nav_mode="jrAction" profile_url=$profile_url}
    <div class="box_body">
        <div class="wrap">
            {if jrUser_is_logged_in() && jrUser_is_linked_to_profile($_profile_id)}
                {if jrCore_module_is_active('n8Ajax')}
                    ...
                    <div class="action_submit">
                        ...
                        <button id="action_submit" class="form_button">{jrCore_lang skin=$_conf.jrCore_active_skin id="79" default="Post"}</button>
                    </div>
                {else}
                    <div id="editor-input">
                        {jrAction_form}

...
{if !isset($_conf.n8MSkinX_forum_profile) || strpos($current_url, $_conf.n8MSkinX_forum_profile) !== 0}
    {jrProfile_disable_header}
    {jrProfile_disable_sidebar}

    <div class="page_nav clearfix">
        <div class="breadcrumbs">
            {n8MSkinX_breadcrumbs nav_mode="jrForum" profile_url=$profile_url profile_name=$profile_name page="index"}
        </div>

{if !isset($_post._2)}
    ...
    <div class="page_nav clearfix">
        <div class="breadcrumbs">
            {n8MSkinX_breadcrumbs nav_mode="jrVideo" profile_url=$profile_url page="group"}
        </div>
    ...
    <div class="col8">
        <div class="box">
            {n8MSkinX_sort template="sort_group.tpl" nav_mode="jrVideo" profile_url=$profile_url}
            <div class="box_body">
                <div class="wrap">
...
{else}
    ...
    {literal}
        ...
        <div class="page_nav clearfix">
            <div class="breadcrumbs">
                {n8MSkinX_breadcrumbs nav_mode="jrVideo" profile_url=$_items[0].profile_url page="group" item=$_items[0]}
            </div>
            <div class="action_buttons">
       ...
       <div class="col8">
           <div class="box">
               ...
               {n8MSkinX_sort template="sort_group.tpl" nav_mode="jrVideo" profile_url=$_items[0].profile_url}
               <div class="box_body">
                   <div class="wrap detail_section">
                       ...
                       <div class="detail_box">
                           <div class="header">
                               ...
                               <div style="width:75%;">{jrCore_lang skin="n8MSkinX" id=42 default="Title"}</div>
                               <div style="width:15%;">{jrCore_lang skin="n8MSkinX" id=43 default="Buy"}</div>
                               <div style="width:5%;">{jrCore_lang skin="n8MSkinX" id=44 default="Add"}</div>
                           </div>
                           <div class="media">
                       ...
                       <div class="action_feedback">
                           {n8MSkinX_feedback_buttons module="jrVideo" item=$_items.0}

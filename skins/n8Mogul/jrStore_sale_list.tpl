...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8Mogul_breadcrumbs nav_mode="jrStore" profile_url=$profile_url profile_name=$profile_name page="index"}
    </div>
...
<div class="box">
    {n8Mogul_sort template="sort_index.tpl" nav_mode="jrStore" profile_url=$profile_url}

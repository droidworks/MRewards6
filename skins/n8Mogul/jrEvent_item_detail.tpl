...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8Mogul_breadcrumbs nav_mode="jrEvent" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
            ...
            <div class="wrap detail_section">
                <div class="media">
                    <div class="wrap">
                        ...
                        <span class="location">Location: {$item.event_location}</span>
                        <span class="date">Date: {$item.event_date|jrCore_date_format:"%A %B %e %Y, %l:%M %p"}</span><br>
                ...
                <div class="action_feedback">
                    {n8Mogul_feedback_buttons module="jrEvent" item=$item}

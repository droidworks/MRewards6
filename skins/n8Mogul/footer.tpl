        ...
        <div class="col12">
            <div class="social">
                ...
                <ul class="social clearfix">
                    <li><a href="{$_conf.n8Mogul_facebook_url}" class="social-facebook" target="_blank"></a></li>
                    <li><a href="{$_conf.n8Mogul_twitter_url}" class="social-twitter" target="_blank"></a></li>
                    <li><a href="{$_conf.n8Mogul_google_url}" class="social-google" target="_blank"></a></li>
                    <li><a href="{$_conf.n8Mogul_linkedin_url}" class="social-linkedin" target="_blank"></a></li>
                    <li><a href="{$_conf.n8Mogul_youtube_url}" class="social-youtube" target="_blank"></a></li>
                </ul>

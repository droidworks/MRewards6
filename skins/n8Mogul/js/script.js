...
function init() {
    ...
    $('div#slides .next > a').click(function(){
        var p = $(this).parent().parent();

        if (p.hasClass('page_1')) {
            p.removeClass('page_1').addClass('page_2');
        }
        else if (p.hasClass('page_2')) {
            p.removeClass('page_2').addClass('page_3');
        }
        else if (p.hasClass('page_3')) {
            p.removeClass('page_3').addClass('page_4');
        }
        else if (p.hasClass('page_4')) {
            p.removeClass('page_4').addClass('page_5');
        }
    });

    $('div#slides .prev > a').click(function(){
        var p = $(this).parent().parent();

        if (p.hasClass('page_5')) {
            p.removeClass('page_5').addClass('page_4');
        }
        else if (p.hasClass('page_4')) {
            p.removeClass('page_4').addClass('page_3');
        }
        else if (p.hasClass('page_3')) {
            p.removeClass('page_3').addClass('page_2');
        }
        else if (p.hasClass('page_2')) {
            p.removeClass('page_2').addClass('page_1');
        }
    });

    $('.nav li#tab_1').click(function(){
        var p = $('#slides');
        p.removeClass('page_5 page_4 page_3 page_2 page_1').addClass('page_1');
    });
    $('.nav li#tab_2').click(function(){
        var p = $('#slides');
        p.removeClass('page_5 page_4 page_3 page_2 page_1').addClass('page_2');
    });
    $('.nav li#tab_3').click(function(){
        var p = $('#slides');
        p.removeClass('page_5 page_4 page_3 page_2 page_1').addClass('page_3');
    });
    $('.nav li#tab_4').click(function(){
        var p = $('#slides');
        p.removeClass('page_5 page_4 page_3 page_2 page_1').addClass('page_4');
    });
    $('.nav li#tab_5').click(function(){
        var p = $('#slides');
        p.removeClass('page_5 page_4 page_3 page_2 page_1').addClass('page_5');
    });

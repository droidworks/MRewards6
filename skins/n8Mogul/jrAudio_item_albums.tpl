{if !isset($_post._2)}
    ...
    <div class="page_nav clearfix">
        <div class="breadcrumbs">
            {n8Mogul_breadcrumbs nav_mode="jrAudio" profile_url=$profile_url profile_name=$profile_name page="group"}
        </div>
    ...
    <div class="col8">
        <div class="box">
            {n8Mogul_sort template="sort_group.tpl" nav_mode="jrAudio" profile_url=$profile_url}
...
{else}
    ...
    {literal}
        ...
        <div>
            <div class="page_nav clearfix">
                <div class="breadcrumbs">
                    {n8Mogul_breadcrumbs nav_mode="jrAudio" profile_url=$_items[0].profile_url profile_name=$_items[0].profile_name page="group" item=$_items[0]}
                </div>
                <div class="action_buttons">
            ...
            <div class="col8">
                <div class="box">
                    {n8Mogul_sort template="sort_group.tpl" nav_mode="jrAudio" profile_name=$_items[0].profile_name profile_url=$_items[0].profile_url}
                    ...
                    <div class="box_body">
                        <div class="wrap detail_section">
                            ...
                            <div class="action_feedback">
                                {n8Mogul_feedback_buttons module="jrAudio" item=$_items.0}

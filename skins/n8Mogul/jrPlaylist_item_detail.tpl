...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8Mogul_breadcrumbs nav_mode="jrPlaylist" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        <ul class="head_tab">
            <li id="album_tab">
                <a href="#" title="{jrCore_lang module="jrPlaylist" id=1 default="Audio"}"></a>
            </li>
        </ul>
        ...
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                <div class="action_feedback">
                    {n8Mogul_feedback_buttons module="jrPlaylist" item=$item}

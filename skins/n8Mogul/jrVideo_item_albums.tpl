{if !isset($_post._2)}
    ...
    <div class="page_nav clearfix">
        <div class="breadcrumbs">
            {n8Mogul_breadcrumbs nav_mode="jrVideo" profile_url=$profile_url profile_name=$profile_name page="group"}
        </div>
    ...
    <div class="col8">
        <div class="box">
            {n8Mogul_sort template="sort_group.tpl" nav_mode="jrVideo" profile_url=$profile_url}
...
{else}
    ...
    {literal}
        ...
        <div class="page_nav clearfix">
            <div class="breadcrumbs">
                {n8Mogul_breadcrumbs nav_mode="jrVideo" profile_url=$_items[0].profile_url page="group" item=$_items[0]}
            </div>
            <div class="action_buttons">
       ...
       <div class="col8">
           <div class="box">
               {n8Mogul_sort template="sort_group.tpl" nav_mode="jrVideo" profile_url=$_items[0].profile_url}
               ...
               <div class="box_body">
                   <div class="wrap detail_section">
                       ...
                       <div class="action_feedback">
                           {n8Mogul_feedback_buttons module="jrVideo" item=$_items.0}

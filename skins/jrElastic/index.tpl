    ...
    <div class="row">
        ...
        <div class="col3">
            ...
            <div class="block">
                ...
                <div class="block_content">
                    <div class="item">
                        {jrCore_list module="jrProfile" order_by="_item_id desc" search1="profile_active = 1" template="index_list_profiles.tpl" limit="5" require_image="profile_image"}
                    </div>
                </div>
            </div>
            ...
            {if jrCore_module_is_active('jrAudio')}
                <div class="block">
                    ...
                    <div class="block_content">
                        <div class="item">
                            {jrCore_list module="jrAudio" order_by="_item_id desc" template="index_list_audio.tpl" limit="5" require_image="audio_image"}
                        </div>
                    </div>
                </div>
            {/if}
            ...
            {if jrCore_module_is_active('jrGroup')}
                <div class="block">
                    ...
                    <div class="block_content">
                        <div class="item">
                            {jrCore_list module="jrGroup" order_by="_item_id desc" template="index_list_group.tpl" limit="5" require_image="group_image"}
                        </div>
                    </div>
                </div>
            {/if}
            ...
            <div class="block">
                            ...
                            <div class="ioutline">
                                <ul id="slider1" class="rslides callbacks">
                                    {if isset($_conf.jrElastic_profile_ids) && strlen($_conf.jrElastic_profile_ids) > 0}
                                        {jrCore_list module="jrProfile" order_by="_item_id desc" limit="10" search1="_profile_id in `$_conf.jrElastic_profile_ids`" search2="profile_active = 1" template="index_featured_slider.tpl" require_image="profile_image"}
                                    {else}
                ...
                {if jrCore_module_is_active('jrGallery')}
                    <div style="margin-top:7px;">
                        ...
                        <div class="block_content">
                            <div class="item">
                                {jrCore_list module="jrGallery" order_by="_item_id desc" limit="12" template="index_list_gallery.tpl"}
                            </div>
                        </div>
                    </div>
                {/if}
        ...
        <div class="col3 last">
            ...
            <div class="block">{jrCore_module_url module="jrBlog" assign="blog_murl"}
                ...
                <div class="block_content">
                    <div class="item">
                        {jrCore_list module="jrBlog" order_by="_item_id desc" template="index_list_blogs.tpl" limit="5"}
                    </div>
                </div>
            </div>
            ...
            {if jrCore_module_is_active('jrVideo')}
                <div class="block">
                    ...
                    <div class="block_content">
                        <div class="item">
                            {jrCore_list module="jrVideo" order_by="_item_id desc" template="index_list_videos.tpl" limit="5" require_image="video_image"}
                        </div>
                    </div>
                </div>
            {/if}
            ...
            {if jrCore_module_is_active('jrGroupDiscuss')}
                <div class="block">
                    ...
                    <div class="block_content">
                        <div class="item">
                            {jrCore_list module="jrGroupDiscuss" order_by="_item_id desc" template="index_list_discuss.tpl" limit="5"}
                        </div>
                    </div>
                </div>
            {/if}

...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8FanClub_breadcrumbs nav_mode="jrAudio" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
        ...
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                {elseif $item.audio_file_extension == 'mp3'}
                    {jrCore_media_player module="jrAudio" field="audio_file" item=$item autoplay=$_conf.n8FanClub_auto_play}
                {/if}
                <div class="detail_box">
                    <div class="basic-info">
                        <div class="trigger"><span>{jrCore_lang skin=$_conf.jrCore_active_skin id="121" default="Basic Info"}</span></div>
                    ...
                    {if strlen($item.audio_lyrics) > 0}
                        <div class="lyrics">
                            <div class="trigger"><span>{jrCore_lang skin=$_conf.jrCore_active_skin id="122" default="Lyrics"}</span></div>
                            <div class="item" style="display: none;">
                                {$item.audio_lyrics}
                            </div>
                        </div>
                ...
                <div class="action_feedback" style="padding: 0">
                    {n8FanClub_feedback_buttons module="jrAudio" item=$item}

                                    ...
                                    <div id="c{$_widget.widget_id}" class="sb-widget-block box">
                                        ...
                                        {elseif strlen($_widget.widget_module) > 0}
                                            {if $_widget.widget_module == 'jrCore'}
                                                ...
                                                {n8FanClub_sort template="sort_index.tpl" nav_mode=$data.list_module title=$_widget.widget_title} <span>{$_widget.widget_title}</span>
                                            {else}
                                                {n8FanClub_sort template="sort_index.tpl" nav_mode=$_widget.widget_module title=$_widget.widget_title} <span>{$_widget.widget_title}</span>
                                            {/if}
                                        {/if}
                                        {if jrUser_is_master()}

...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8FanClub_breadcrumbs nav_mode="jrPoll" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        <ul class="head_tab">
            <li id="stats_tab">
                <a href="#" title="{jrCore_lang module="jrPoll" id="1" default="Poll"}"></a>
            </li>
        </ul>
        <div class="box_body">
            <div class="wrap detail_section">
                <div class="media">
                    <div class="wrap">
                        ...
                        <span class="title">{$item.poll_title}</span>
                ...
                <div class="action_feedback">
                    {n8FanClub_feedback_buttons module="jrPoll" item=$item}

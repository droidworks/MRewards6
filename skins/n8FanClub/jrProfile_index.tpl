    ...
    <div class="row">
        <div class="col8">
            <div  style="padding: 0 1em 0 0;">
                <div class="box">
                    {n8FanClub_sort template="sort_index.tpl" nav_mode="jrProfile" profile_url=$profile_url}
        ...
        <div class="col4">
            <div class="box">
                ...
                <span>{jrCore_lang skin="n8FanClub" id=31 default="Charts"}</span>
                <input type="hidden" id="murl" value="{$murl}"/>
                ...
                <div class="box_body">
                    <div class="wrap">
                        <div id="chart">
                            {jrCore_list module="jrProfile" order_by="profile_like_count numerical_desc" template="chart_profile.tpl"  pagebreak=6}
                        </div>
                    </div>
                </div>
            </div>

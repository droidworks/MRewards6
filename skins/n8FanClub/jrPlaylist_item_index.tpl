...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8FanClub_breadcrumbs nav_mode="jrPlaylist" profile_url=$profile_url profile_name=$profile_name page="detail"}
    </div>
...
<div class="col8">
    <div class="box">
        {n8FanClub_sort template="sort_index.tpl" nav_mode="jrPlaylist" profile_url=$profile_url}

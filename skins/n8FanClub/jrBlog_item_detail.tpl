...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {n8FanClub_breadcrumbs nav_mode="jrBlog" profile_url=$item.profile_url page="detail" item=$item}
    </div>
            ...
            <div class="wrap detail_section">
                <div class="media">
                    <div class="wrap clearfix">
                        ...
                        <br>
                        {if strlen($_conf.n8FanClub_featured_story_ids) > 0}
                            <h2>{jrCore_lang skin=$_conf.jrCore_active_skin id="120" default="Recommended"}</h2>
                            <div class="recommended">
                                {jrCore_list module="jrBlog" search="_item_id in `$_conf.n8FanClub_featured_story_ids`" order_by="_created RANDOM" limit="4" template="blog_recommend.tpl"}
                            </div>
                        {/if}
                    </div>
                </div>
                ...
                <div class="action_feedback">
                    {n8FanClub_feedback_buttons module="jrBlog" item=$item}

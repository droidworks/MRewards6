...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8FanClub_breadcrumbs nav_mode="jrYouTube" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
    ...
    <div class="box">
        ...
        <div class="box_body">
            <div class="wrap detail_section">
                {jrYouTube_embed type="iframe" item_id=$item._item_id auto_play=$_conf.n8FanClub_auto_play width="100%"}
                <div class="detail_box">
                    <div>
                        <div class="header">
                            <div>{jrCore_lang skin="n8FanClub" id=41 default="Category"}</div>
                            <div>{jrCore_lang skin="n8FanClub" id=45 default="Duration"}</div>
                            <div>{jrCore_lang skin="n8FanClub" id=40 default="Created"}</div>
                            <div>{jrCore_lang skin="n8FanClub" id=38 default="Plays"}</div>
                        </div>
                        <div class="details">
                ...
                {if jrUser_is_logged_in()}
                    <div class="action_feedback">
                        {n8FanClub_feedback_buttons module="jrYouTube" item=$item}

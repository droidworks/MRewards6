...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8FanClub_breadcrumbs nav_mode="jrSoundCloud" profile_url=$profile_url profile_name=$profile_name page="index"}
    </div>
...
<div class="col8">
    <div class="box">
        {n8FanClub_sort template="sort_index.tpl" nav_mode="jrSoundCloud" profile_url=$profile_url}

    ...
    <div id="footer_content">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col2">
                    <div id="footer_logo">
                        {jrCore_image image="logo.png" width="150" height="38" alt="ParadigmDark Skin &copy; {$smarty.now|date_format:"%Y"} The Jamroom Network" title="ParadigmDark Skin &copy; {$smarty.now|date_format:"%Y"} The Jamroom Network"}
                    </div>
                </div>
                ...
                <div class="col3 last">
                    <div id="footer_sn">
                        ...
                        {if strlen($_conf.kmParadigmDark_twitter_name) > 0}
                            <a href="https://twitter.com/{$_conf.kmParadigmDark_twitter_name}" target="_blank">{jrCore_image image="sn-twitter.png" width="24" height="24" class="social-img" alt="twitter" title="Follow @{$_conf.kmParadigmDark_twitter_name}"}</a>
                        {/if}

                        {if strlen($_conf.kmParadigmDark_facebook_name) > 0}
                            <a href="https://facebook.com/{$_conf.kmParadigmDark_facebook_name}" target="_blank">{jrCore_image image="sn-facebook.png" width="24" height="24" class="social-img" alt="facebook" title="Like {$_conf.kmParadigmDark_facebook_name} on Facebook"}</a>
                        {/if}

                        {if strlen($_conf.kmParadigmDark_linkedin_name) > 0}
                            <a href="https://linkedin.com/{$_conf.kmParadigmDark_linkedin_name}" target="_blank">{jrCore_image image="sn-linkedin.png" width="24" height="24" class="social-img" alt="linkedin" title="Link up with {$_conf.kmParadigmDark_linkedin_name} on LinkedIn"}</a>
                        {/if}

                        {if strlen($_conf.kmParadigmDark_google_name) > 0}
                            <a href="https://plus.google.com/{$_conf.kmParadigmDark_google_name}" target="_blank">{jrCore_image image="sn-google-plus.png" width="24" height="24" class="social-img" alt="google+" title="Follow {$_conf.kmParadigmDark_google_name} on Google+"}</a>
                        {/if}

                        {if strlen($_conf.kmParadigmDark_youtube_name) > 0}
                            <a href="https://www.youtube.com/channel/{$_conf.kmParadigmDark_youtube_name}" target="_blank">{jrCore_image image="sn-youtube.png" width="24" height="24" class="social-img" alt="youtube" title="Subscribe to {$_conf.kmParadigmDark_youtube_name} on YouTube"}</a>
                        {/if}

                        {if strlen($_conf.kmParadigmDark_pinterest_name) > 0}
                            <a href="https://www.pinterest.com/{$_conf.kmParadigmDark_pinterest_name}" target="_blank">{jrCore_image image="sn-pinterest.png" width="24" height="24" class="social-img" alt="pinterest" title="Follow {$_conf.kmParadigmDark_pinterest_name} on Pinterest"}</a>
                        {/if}

                    ...
                    <div class="row">
                        <div class="col12 last">
                            ...
                            <div class="body_3 mb20">
                                <div id="station_div">
                                {if isset($_conf.kmParadigmDark_auto_play) && $_conf.kmParadigmDark_auto_play == 'on'}
                                ...
                                {elseif isset($_conf.kmParadigmDark_radio_title) && strlen($_conf.kmParadigmDark_radio_title) > 0}
                                    {jrCore_list module="jrPlaylist" order_by="_created desc" search1="playlist_list like %jrAudio%" search2="playlist_title = `$_conf.kmParadigmDark_radio_title`" limit="1" template="station_playlist.tpl" autoplay=$sap}
                                {else}

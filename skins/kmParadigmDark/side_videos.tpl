...
<table class="menu_tab">
    <tr>
        {if isset($_conf.kmParadigmDark_v_category) && $_conf.kmParadigmDark_v_category == 'on'}
...
<div class="page mb20 pt10">
    ...
    {if isset($_conf.kmParadigmDark_featured_video) && strlen($_conf.kmParadigmDark_featured_video) > 0}
        {jrCore_list module="jrVideo" order_by="_item_id desc" limit="1" search1="profile_active = 1" search2="_item_id = `$_conf.kmParadigmDark_featured_video`" template=$featured_video}
    {else}
        {jrCore_list module="jrVideo" order_by="video_file_stream_count numerical_desc" limit="1" search1="profile_active = 1" quota_id=$_conf.kmParadigmDark_artist_quota template=$featured_video}
    {/if}
</div>

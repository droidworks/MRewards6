    ...
    <nav>
        ...
        {else}
            ...
            <li>
                ...
                {if $_conf.kmParadigmDark_artist_quota > 0 || $_conf.kmParadigmDark_member_quota > 0}
                    <ul>
                        {if $_conf.kmParadigmDark_artist_quota > 0}
                            <li><a href="{$jamroom_url}/artists">{jrCore_lang skin=$_conf.jrCore_active_skin id="48" default="artists"}</a></li>
                        {/if}
                        {if $_conf.kmParadigmDark_member_quota > 0}
            ...
            {if isset($_conf.kmParadigmDark_forum_profile_url) && strlen($_conf.kmParadigmDark_forum_profile_url) > 0}
                {assign var="forum_url" value=$_conf.kmParadigmDark_forum_profile_url}
            {/if}
            ...
            {if isset($_conf.kmParadigmDark_docs_profile_url) && strlen($_conf.kmParadigmDark_docs_profile_url) > 0}
                {assign var="doc_url" value=$_conf.kmParadigmDark_docs_profile_url}
            {/if}

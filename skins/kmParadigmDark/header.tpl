...
{*                <div class="col6">    *}
                    ...
                    <div id="main_logo">
                        {if jrCore_is_mobile_device() || jrCore_is_tablet_device()}
                            {jrCore_image id="mmt" skin="kmParadigmDark" image="menu.png" alt="menu" style="max-width:28px;max-height:28px;"}
                        ...
                        {else}
                            <a href="{$jamroom_url}">{jrCore_image image="logo.png" class="img_scale" alt=$_conf.jrCore_system_name title=$_conf.jrCore_system_name style="max-width:780px;max-height:120px;position: relative; left: 160px;" custom="logo"}</a>
                        {/if}
{*                    </div>         *}
                </div>
{*                <div class="col6 last">
                    <div class="logo-ads">
                        {if $_conf.kmParadigmDark_ads_off != 'on'}
                            ...
                            {elseif isset($_conf.kmParadigmDark_top_ad) && strlen($_conf.kmParadigmDark_top_ad) > 0}
                                {$_conf.kmParadigmDark_top_ad}
                            {else}

        ...
        <div class="col9">
            ...
            <div class="body_1 mr5">
                ...
                {if isset($_conf.kmParadigmDark_blog_profile) && $_conf.kmParadigmDark_blog_profile > 0}
                    {jrCore_list module="jrBlog" order_by="_created desc" search1="_profile_id = `$_conf.kmParadigmDark_blog_profile`" search2="blog_category = blog OR blog_category = Blog" template="blog_row.tpl" pagebreak="1" page=$_post.p}
                {else}

            ...
            <div class="row">
                ...
                <div class="col4 last">
                    <div class="block_config">
                        ...
                        {if !isset($item.bundle_item_price) || strlen($item.bundle_item_price) === 0 || $item.bundle_item_price == '0'}
                            <div class="add_to_cart_section"><a href="{$jamroom_url}/{$item.profile_url}/{$fcburl}/{$item._item_id}/{$item.bundle_title_url}" title="View Bundle"><span class="add_to_cart_price">free download via marketplace</span></a><a href="{$jamroom_url}/{$item.profile_url}/{$fcburl}/{$item._item_id}/{$item.bundle_title_url}" title="View Bundle">{jrCore_icon icon="bundle"}</a></div>
                        {/if}
                    </div>
                </div>
            </div>

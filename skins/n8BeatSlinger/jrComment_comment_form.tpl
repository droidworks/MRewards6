    ...
    <div id="comment_form_section" style="display: table; width: 100%;">
        <div id="comment_area" style="display: table-row">
                ...
                <div>
                    ...
                    {if jrUser_is_logged_in()}
                        <form class="comment_form" id="{$jrComment.unique_id}_form" action="{$jamroom_url}/comment/comment_save" method="POST"
                            ...
                            {if $_user.quota_jrComment_attachments == 'on' && $jrComment.module != 'jrAction' && (!isset($_conf.jrComment_editor) && $_conf.jrComment_editor != 'on')}
            ...
            <div class="comment_submit" style="display: table-cell; padding: 0 5px;">
                <button class="form_button" id="comment_submit_{$jrComment.unique_id}" onclick="n8PostComment('#{$jrComment.unique_id}', 'undefined', 500, '{$_conf.jrComment_editor}', '{$jrComment.module}', '{$jrComment.item_id}');return false">Post</button>
            </div>

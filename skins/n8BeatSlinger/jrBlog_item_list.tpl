...
{jrProfile_disable_sidebar}
    ...
    <div class="page_nav clearfix">
        <div class="breadcrumbs">
            <a href="{$jamroom_url}/{$_items[0].profile_url}">{$_items[0].profile_name}</a>
            {if strlen($_post._2) > 0}
                {n8BeatSlinger_breadcrumbs nav_mode="jrBlog" profile_url=$profile_url page="group" item=$_items[0]}
            {else}
                {n8BeatSlinger_breadcrumbs nav_mode="jrBlog" profile_url=$profile_url page="group"}
            {/if}
        </div>
...
<div class="col8">
    <div class="main">
        <div class="box">
            {n8BeatSlinger_sort template="sort_group.tpl" nav_mode="jrBlog" profile_url=$profile_url}

...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        playlist_1 = new jPlayerPlaylist({
            ...
            play : function () {
                var player = $('.n8Player_beat_player');
        ...
        $('.n8Player_beat_player .jp-stop').click(function(){
            $('.n8Player_beat_player').removeClass('playing min');
        });

        $('.n8Player_beat_player .jp-min').click(function(){
            $('.n8Player_beat_player').toggleClass('min');
        });

        $('.n8Player_beat_player .jp-close a').click(function(e){
            e.preventDefault();
            $('.n8Player_beat_player .jp-playlist-bg').toggle();
        });
    ...
    function showBeatInfo(song) {
        ...
        $('.n8Player_beat_player .jp-buy button')
                .text(price)
                .prop('disabled', false)
                .unbind('click')
                .click(function(){
        ...
        if (song.price == 0) {
            $('.n8Player_beat_player .jp-buy button').prop('disabled', 'disabled').unbind('click');
        }
...
<div class="n8Player_beat_player"
                ...
                <div class="jp-interface">
                    <div class="jp-controls-holder">
                        <ul class="jp-controls clearfix">
                            ...
                            <li><a href="javascript:" class="jp-min" tabindex="1"
                                   title="{jrCore_lang skin=$_conf.jrCore_active_skin id="100" default="minimize"}"></a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="col4 jp-clock" style="position: relative;">
                            <div class="wrap">
                                ...
                                <ul class="jp-controls">
                                    ...
                                    <li><a href="javascript:" class="jp-show" tabindex="1" title="Toggle Playlist"></a></li>
                                </ul>
                ...
                <div class="jp-playlist-bg" style="display: none;">
                    <div class="jp-playlist-wrap">
                        <div class="jp-playlist" style="display: block;">
                            <div class="jp-head">
                                <div style="padding: 10px 20px;">{$_conf.jrCore_system_name} {jrCore_lang skin=$_conf.jrCore_active_skin id=102 default="Playlist"}</div>
                                <div class="jp-close">
                                    <a href="#"></a>
                                </div>
                            </div>

<div class="box">
    {n8BeatSlinger_sort template="sort_index.tpl" nav_mode="jrAction" profile_url=$profile_url}
    <div class="box_body">
        <div class="wrap">
                ...
                {if jrCore_module_is_active('n8Ajax')}
                    <div id="action_area">
                        ...
                        <div class="textArea">
                            ...
                            <textarea class="form_textarea" name="action_text" id="action_text" rows="1"
                                      placeholder="{jrCore_lang skin=$_conf.jrCore_active_skin id="78" default="What's on your mind?..."}"></textarea>
                    ...
                    <div class="action_submit">
                        ...
                        <img width="24" height="24" alt="working..."
                             src="{$jamroom_url}/image/img/skin/n8Tunetrax/submit.gif" id="action_submit_indicator">
                        <button id="action_submit"
                                class="form_button">{jrCore_lang skin=$_conf.jrCore_active_skin id="79" default="Post"}</button>
                    </div>
                {else}
                    <div id="editor-input">
                        {jrAction_form}

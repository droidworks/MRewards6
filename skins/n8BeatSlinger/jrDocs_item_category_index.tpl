...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8BeatSlinger_breadcrumbs nav_mode="jrDocs" profile_url=$profile_url profile_name=$profile_name page="group" item=$_items[0]}
    </div>
...
<div class="box">
    {n8BeatSlinger_sort template="sort_index.tpl" nav_mode="jrDocs" profile_url=$profile_url}
    <input type="hidden" id="murl" value="{$murl}"/>
    <input type="hidden" id="target" value="#list"/>
    <input type="hidden" id="pagebreak" value="12"/>
    <input type="hidden" id="mod" value="jrDocs"/>

    ...
    <div class="row">
        <div class="col8">
            <div  style="padding: 0 1em 0 0;">
                <div class="box">
                    {n8BeatSlinger_sort template="sort_index.tpl" nav_mode="jrProfile" profile_url=$profile_url}
                    ...
                    <div class="box_body">
                        <div class="wrap">
                            <div id="list">
                                {jrCore_list module="jrProfile" order_by="_item_id numerical_desc" pagebreak=10 page=$_post.p pager=true}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col4">
            <div class="box">
                ...
                <span>{jrCore_lang skin="n8BeatSlinger" id=31 default="Charts"}</span>
                <input type="hidden" id="murl" value="{$murl}"/>
                ...
                <div class="box_body">
                    <div class="wrap">
                        <div id="chart">
                            {jrCore_list module="jrProfile" order_by="profile_like_count numerical_desc" template="chart_profile.tpl"  pagebreak=8 page=$_post.p pager=true}
                        </div>
                    </div>
                </div>
            </div>

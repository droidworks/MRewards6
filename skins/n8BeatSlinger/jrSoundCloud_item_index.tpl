...
<div class="page_nav">
    <div class="breadcrumbs">
        {n8BeatSlinger_breadcrumbs nav_mode="jrSoundCloud" profile_url=$profile_url page="index"}
    </div>
...
<div class="box">
    {n8BeatSlinger_sort template="sort_index.tpl" nav_mode="jrSoundCloud" profile_url=$profile_url}

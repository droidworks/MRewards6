...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8BeatSlinger_breadcrumbs nav_mode="jrPoll" profile_url=$profile_url profile_name=$profile_name page="index"}
    </div>
...
<div class="box">
    {n8BeatSlinger_sort template="sort_index.tpl" nav_mode="jrPoll" profile_url=$profile_url}

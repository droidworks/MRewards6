...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8BeatSlinger_breadcrumbs nav_mode="jrGallery" profile_url=$_items[0].profile_url profile_name=$_items[0].profile_name page="group" item=$_items[0]}
    </div>
...
<div class="box">
    <ul class="head_tab">
        <li id="gallery_tab"><a href="{$jamroom_url}/{$_items[0].profile_url}/{$murl}" title="{jrCore_lang module="jrGallery" id=38 default="Images"}"></a></li>
    </ul>
    <div class="box_body">
        <div class="wrap detail_section">
            ...
            <div class="action_feedback">
                {n8BeatSlinger_feedback_buttons module="jrGallery" item=$item}

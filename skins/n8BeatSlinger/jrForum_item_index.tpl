...
{if !isset($_conf.n8BeatSlinger_forum_profile) || strpos($current_url, $_conf.n8BeatSlinger_forum_profile) !== 0}
    {jrProfile_disable_header}
    {jrProfile_disable_sidebar}

    <div class="page_nav clearfix">
        <div class="breadcrumbs">
            {n8BeatSlinger_breadcrumbs nav_mode="jrForum" profile_url=$profile_url profile_name=$profile_name page="index"}
        </div>
        <div class="action_buttons">
            {jrCore_item_index_buttons module="jrForum" profile_id=$_profile_id}
        </div>
    </div>
    <style>
        .page_nav.clearfix {
        ...
        .col12.last > div > div:first-child {

...
<nav>
    ...
    {/if}
        ...
        {if jrUser_is_admin() || jrUser_get_profile_home_key('quota_jrChat_allowed') == 'on'}
            <li><a href="{$jamroom_url}/chat/mobile" target="_blank">{jrCore_lang skin="jrNewLucid" id=91 default="User Chat"}</a></li>
        {/if}
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="https://www.jamroom.net/the-jamroom-network/documentation/modules/2857/system-core" target="_blank">{jrCore_lang skin="jrNewLucid" id=87 default="Documentation"}</a></li>
                            ...
                            <li><a href="https://www.jamroom.net/ticket/create" target="_blank">{jrCore_lang skin="jrNewLucid" id=89 default="VIP Support"}</a></li>

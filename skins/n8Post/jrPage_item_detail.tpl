...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8Post_breadcrumbs nav_mode="jrPage" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
            ...
            {if $_post.module_url != 'page'}
                ...
                <div class="action_feedback">
                    ...
                    {if !isset($item.page_features) || $item.page_features == 'on'}
                        {n8Post_feedback_buttons module="jrPage" item=$item}

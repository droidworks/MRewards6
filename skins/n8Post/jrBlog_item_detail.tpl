...
<div class="page_nav">
    <div class="breadcrumbs">
        ...
        {n8Post_breadcrumbs nav_mode="jrBlog" profile_url=$item.profile_url page="detail" item=$item}
    </div>
        ...
        <div class="box_body">
            <div class="wrap detail_section">
                    ...
                    <div class="wrap clearfix">
                        ...
                        {if strlen($_conf.n8Post_featured_story_ids) > 0}
                            ...
                            <div class="recommended">
                                {jrCore_list module="jrBlog" search="_item_id in `$_conf.n8Post_featured_story_ids`" order_by="_created RANDOM" limit="4" template="blog_recommend.tpl"}
                            </div>
                        {/if}
                    </div>
                </div>
                ...
                <div class="action_feedback">
                    {n8Post_feedback_buttons module="jrBlog" item=$item}

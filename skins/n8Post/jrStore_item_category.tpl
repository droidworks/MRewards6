...
{if !isset($_post._2)}
    ...
    <div class="box">
        {n8Post_sort template="sort_group.tpl" nav_mode="jrStore" profile_url=$profile_url}
        <div class="box_body">
            <div class="wrap">
                <div id="list">
...
{else}
    ...
    {literal}
        ...
        <div class="page_nav clearfix">
            <div class="breadcrumbs">
                {n8Post_breadcrumbs nav_mode="jrStore" profile_url=$_items[0].profile_url profile_name=$_items[0].profile_name page="group" item=$_items[0]}
            </div>
            <div class="action_buttons">
        ...
        <div class="col8">
            <div class="box">
                {n8Post_sort template="sort_group.tpl" nav_mode="jrStore" profile_url=$_items[0].profile_url}
                <div class="box_body">
                    <div class="wrap">
                        <div id="list">

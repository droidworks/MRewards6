...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8Post_breadcrumbs nav_mode="jrGuestBook" profile_url=$profile_url profile_name=$profile_name page="detail"}
    </div>
...
<div class="box">
    {n8Post_sort template="sort_index.tpl" nav_mode="jrGuestBook" profile_url=$profile_url}

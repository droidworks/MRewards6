...
{jrCore_lang skin=$_conf.jrCore_active_skin id="66" default="Terms Of Service" assign="page_title"}
        ...
        <div class="title">
            {if jrUser_is_admin()}
                <div class="block_config">
                    <a href="{$jamroom_url}/page/admin/tools" title="update" href="{$jamroom_url}/page/admin/tools">{jrCore_icon icon="gear" size="16"}</a>
                </div>
            {/if}
            <h1>{$_conf.jrCore_system_name} {jrCore_lang skin=$_conf.jrCore_active_skin id="66" default="Terms Of Service"}</h1>
            <div class="breadcrumbs">
                <a href="{$jamroom_url}/">{jrCore_lang skin=$_conf.jrCore_active_skin id="1" default="Home"}</a> &raquo; {jrCore_lang skin=$_conf.jrCore_active_skin id="66" default="Terms Of Service"}
            </div>
        </div>

...
{jrCore_lang skin=$_conf.jrCore_active_skin id="69" default="Contact Us" assign="page_title"}
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col12 last">
            ...
            <div class="title">
                <h1>{jrCore_lang skin=$_conf.jrCore_active_skin id="69" default="Contact Us"}</h1>
            </div>
                    ...
                    <div>
                        ...
                        <form id="jrPrivateNote_new" enctype="multipart/form-data" accept-charset="utf-8" method="post" action="{$jamroom_url}/{$notesurl}/new_save" name="jrPrivateNote_new">
                            ...
                            <div class="left capital bold" style="width:75%;margin:0 auto;">
                                {jrCore_lang skin=$_conf.jrCore_active_skin id="75" default="Subject"}:<br><br>
                                <input id="note_subject" class="form_text" type="text" value="" name="note_subject" style="width:100%;">
                            </div>
                            <br><br>
                            <div class="left capital bold" style="width:75%;margin:0 auto;">
                                {jrCore_lang skin=$_conf.jrCore_active_skin id="76" default="message"}:<br><br>
                            ...
                            <div class="center capital bold" style="width:75%;margin:0 auto;">
                                <input id="jrPrivateNote_new_submit" class="form_button" type="submit" value="{jrCore_lang skin=$_conf.jrCore_active_skin id="77" default="Send Message"}">&nbsp;
                                &nbsp;<input type="button" value="{jrCore_lang  skin=$_conf.jrCore_active_skin id="78" default="Cancel"}" onclick="window.location='{$jamroom_url}'" class="form_button">
                            </div>
                        </form>
                    </div>
                {/if}

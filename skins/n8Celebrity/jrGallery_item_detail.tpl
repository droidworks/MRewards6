...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8Celebrity_breadcrumbs nav_mode="jrGallery" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        <ul class="head_tab">
            <li id="gallery_tab"><a href="{$jamroom_url}/{$item.profile_url}/{$murl}" title="{jrCore_lang module="jrGallery" id=38 default="Images"}"></a></li>
        </ul>
        <span>{jrCore_lang skin=$_conf.jrCore_active_skin id="113" default="Images"} by {$item.profile_name}</span>
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                <div class="action_feedback">
                    {n8Celebrity_feedback_buttons module="jrGallery" item=$item}

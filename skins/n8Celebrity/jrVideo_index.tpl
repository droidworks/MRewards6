    ...
    <div class="row">
        <div class="col8">
            <div  style="padding: 0 1em 0 0;">
                <div class="box">
                    {n8Celebrity_sort template="sort_index.tpl" nav_mode="jrVideo" profile_url=$profile_url}
        ...
        <div class="col4">
            <div class="box">
                <ul class="head_tab">
                    <li id="stats_tab">
                        <a href="#" title="{jrCore_lang skin="n8Celebrity" id=32 default="30 Day Charts"}"></a>
                    </li>
                </ul>
                <span>{jrCore_lang skin="n8Celebrity" id=32 default="30 Day Charts"}</span>
                <div class="box_body">
                    <div class="wrap">
                        <div id="list">

...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8Celebrity_breadcrumbs nav_mode="jrBlog" profile_url=$profile_url profile_name=$profile_name page="index"}
    </div>
...
<div class="col8">
    <div class="box">
        {n8Celebrity_sort template="sort_index.tpl" nav_mode="jrBlog" profile_url=$profile_url}

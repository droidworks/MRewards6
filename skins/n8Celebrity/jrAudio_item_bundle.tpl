        ...
        <div class="wrap clearfix">
            ...
            <div class="col8">
                ...
                <div class="data clearfix">
                    <span>{$bundle_item.audio_comment_count|jrCore_number_format} {jrCore_lang skin=$_conf.jrCore_active_skin id="109" default="Comments"}</span>
                    <span>{$bundle_item.audio_like_count|jrCore_number_format} {jrCore_lang skin=$_conf.jrCore_active_skin id="110" default="Likes"}</span>
                </div>
            </div>
        </div>
    </div>

...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8ESkin_breadcrumbs nav_mode="jrAudio" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
        ...
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                {elseif $item.audio_file_extension == 'mp3'}
                    {jrCore_media_player module="jrAudio" field="audio_file" item=$item autoplay=$_conf.n8ESkin_auto_play}
                {/if}
                ...
                <div class="action_feedback" style="padding: 0">
                    {n8ESkin_feedback_buttons module="jrAudio" item=$item}

...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8ESkin_breadcrumbs nav_mode="jrFlickr" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
            ...
            <div class="wrap detail_section">
                ...
                {if jrUser_is_logged_in()}
                    <div class="action_feedback">
                        {n8ESkin_feedback_buttons module="jrFlickr" item=$item}

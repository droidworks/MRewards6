...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8ESkin_breadcrumbs nav_mode="jrAudio" profile_url=$profile_url profile_name=$profile_name page="index"}
    </div>
...
<div class="box">
    {n8ESkin_sort template="sort_index.tpl" nav_mode="jrGroupDiscuss" profile_url=$profile_url}

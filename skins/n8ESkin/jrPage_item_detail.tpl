...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8ESkin_breadcrumbs nav_mode="jrPage" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="box">
    <ul id="actions_tab">
        <li id="page_tab" style="border-radius: 8px 8px 0 0;"><a href="{$jamroom_url}/{$item.profile_url}/{$murl}" title="{jrCore_lang module="jrPage" id="19" default="Pages"}"></a>
        </li>
    </ul>
            ...
            {if $_post.module_url != 'page'}
                ...
                <div class="action_feedback">
                    ...
                    {if !isset($item.page_features) || $item.page_features == 'on'}
                        {n8ESkin_feedback_buttons module="jrPage" item=$item}

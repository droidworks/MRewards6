...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8ESkin_breadcrumbs nav_mode="jrSoundCloud" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
    ...
    <div class="box">
        ...
        <div class="box_body">
            <div class="wrap detail_section">
                {jrSoundCloud_embed item_id=$item._item_id auto_play=$_conf.n8ESkin_auto_play}
                ...
                <div class="action_feedback">
                    {n8ESkin_feedback_buttons module="jrSoundCloud" item=$item}

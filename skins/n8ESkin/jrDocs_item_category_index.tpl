...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8ESkin_breadcrumbs nav_mode="jrDocs" profile_url=$profile_url profile_name=$profile_name page="group" item=$_items[0]}
    </div>
...
<div class="box">
    {n8ESkin_sort template="sort_index.tpl" nav_mode="jrDocs" profile_url=$profile_url}

        ...
        <ul id="menu">
            ...
            {if jrUser_is_master()}
                ...
                <li class="desk right">
                    <a href="{$jamroom_url}/{$core_url}/admin">
                        {jrCore_lang skin=$_conf.jrCore_active_skin id="69" default="ACP" assign="dash"}
                        {jrCore_image image="acp.png" width="22" height="22" alt=$dash}
                    </a>
                    <ul>
                        <li>
            ...
            {elseif jrUser_is_admin()}
                <a href="{$jamroom_url}/{jrCore_module_url module="jrCore"}/dashboard">
                    {jrCore_lang skin=$_conf.jrCore_active_skin id="68" default="dashboard" assign=$dash}
                    {jrCore_image image="acp.png" width="22" height="22" alt="dash"}
                </a>
            {/if}

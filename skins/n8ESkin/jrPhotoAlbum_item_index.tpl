...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8ESkin_breadcrumbs nav_mode="jrPhotoAlbum" profile_url=$profile_url profile_name=$profile_name page="detail"}
    </div>
...
<div class="box">
    {n8ESkin_sort template="sort_index.tpl" nav_mode="jrPhotoAlbum" profile_url=$profile_url}

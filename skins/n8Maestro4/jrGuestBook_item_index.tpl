...
<div class="page_nav">
    <div class="breadcrumbs">
        {n8Maestro4_breadcrumbs nav_mode="jrGuestBook" profile_url=$profile_url page="index"}
    </div>
...
<div class="box">
    {n8Maestro4_sort template="sort_index.tpl" nav_mode="jrGuestBook" profile_url=$profile_url}
    <input type="hidden" id="murl" value="{$murl}"/>
    <input type="hidden" id="target" value="#list"/>
    <input type="hidden" id="pagebreak" value="12"/>
    <input type="hidden" id="mod" value="jrGuestBook"/>
                    ...
                    <div class="wrap">
                        {if jrUser_is_logged_in()}
                            ...
                            <form id="gform" method="POST" onsubmit="jrGuestBook_post_entry('{$_profile_id}','#gform','#guestbooks');return false">
                                ...
                                <textarea name="guestbook_text" cols="40" rows="5" class="form_textarea" placeholder="Say something..."></textarea>
                                <br>

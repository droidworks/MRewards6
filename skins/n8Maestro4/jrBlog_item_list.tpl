    ...
    <div class="page_nav clearfix">
        <div class="breadcrumbs">
            ...
            {if strlen($_post._2) > 0}
                {n8MSkinX_breadcrumbs nav_mode="jrBlog" profile_url=$profile_url page="group" item=$_items[0]}
            {else}
                {n8MSkinX_breadcrumbs nav_mode="jrBlog" profile_url=$profile_url page="group"}
            {/if}
        </div>
...
<div class="col8">
    <div class="main">
        <div class="box">
            {n8MSkinX_sort template="sort_group.tpl" nav_mode="jrBlog" profile_url=$profile_url}

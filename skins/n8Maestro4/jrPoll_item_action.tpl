    ...
    <div class="action_data">
        ...
        {if $item.action_mode == 'create'}
            <span class="action_desc"><a
                        href="{$jamroom_url}/{$item.profile_url}/{$murl}/{$item.action_item_id}/{$item.action_data.audio_title_url}">{jrCore_lang module="jrPoll" id="44" default="Created a Poll"}.</a></span><br>
        {elseif $item.action_mode == 'update'}
            <span class="action_desc"><a
                        href="{$jamroom_url}/{$item.profile_url}/{$murl}/{$item.action_item_id}/{$item.action_data.audio_title_url}"> {jrCore_lang module="jrPoll" id="45" default="Updated a Poll"}.</a></span><br>
        {elseif $item.action_mode == 'vote'}
            <span class="action_desc"><a
                        href="{$jamroom_url}/{$item.profile_url}/{$murl}/{$item.action_item_id}/{$item.action_data.audio_title_url}">{jrCore_lang module="jrPoll" id="46" default="Voted on a Poll"}.</a></span><br>
        {/if}

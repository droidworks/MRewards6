    ...
    <div style="padding-left: 1em">
        ...
        <div class="page_nav">
            <div class="breadcrumbs">
                {n8Maestro4_breadcrumbs nav_mode="jrStore" profile_url=$profile_url page="group"}
            </div>
        ...
        <div class="box">
            {n8Maestro4_sort template="sort_group.tpl" nav_mode="jrStore" profile_url=$profile_url}
            <div class="box_body">
                <div class="wrap">
                    <div class="media">
                        <div class="wrap">
...
{else}
    ...
    {literal}
        ...
        <div style="padding-left: 1em">
            <div class="page_nav">
                <div class="breadcrumbs">
                    {n8Maestro4_breadcrumbs nav_mode="jrStore" profile_url=$_items[0].profile_url page="group" item=$_items[0]}
                </div>
                <div class="action_buttons">
            ...
            <div class="box">
                {n8Maestro4_sort template="sort_group.tpl" nav_mode="jrStore" profile_url=$_items[0].profile_url}
                <div class="box_body">
                    <div class="wrap">
                        <div class="media">

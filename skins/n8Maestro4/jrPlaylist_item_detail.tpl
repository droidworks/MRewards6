...
<div class="page_nav">
    <div class="breadcrumbs">
        {n8Maestro4_breadcrumbs nav_mode="jrPlaylist" profile_url=$item.profile_url page="detail" item=$item}
    </div>
        ...
        <div class="wrap detail_section">
            ...
            <div class="detail_box">
                <div class="header">
                    ...
                    <div style="width:85%;">{jrCore_lang skin="n8Maestro4" id=42 default="Title"}</div>
                    <div style="width:5%;">{jrCore_lang skin="n8Maestro4" id=43 default="Buy"}</div>
            ...
            {if jrUser_is_logged_in()}
                <div class="action_feedback">
                    {n8Maestro4_feedback_buttons module="jrPlaylist" item=$item}

...
<div class="page_nav">
    <div class="breadcrumbs">
        {n8Maestro4_breadcrumbs nav_mode="jrGallery" profile_url=$_items[0].profile_url page="group" item=$_items[0]}
    </div>
    ...
    <div class="box_body">
        <div class="wrap detail_section">
            ...
            <div class="action_feedback">
                {n8Maestro4_feedback_buttons module="jrGallery" item=$item}

...
<div class="page_nav">
    <div class="breadcrumbs">
        {n8Maestro4_breadcrumbs nav_mode="jrGroup" profile_url=$profile_url page="index"}
    </div>
...
<div class="box">
    {n8Maestro4_sort template="sort_index.tpl" nav_mode="jrGroup" profile_url=$profile_url}

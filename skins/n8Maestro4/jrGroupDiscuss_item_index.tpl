...
<div class="page_nav">
    <div class="breadcrumbs">
        {n8Maestro4_breadcrumbs nav_mode="jrGroupDiscuss" profile_url=$profile_url page="index" item=$_group}
    </div>
...
<div class="box">
    {n8Maestro4_sort template="sort_index.tpl" nav_mode="jrGroupDiscuss" profile_url=$profile_url}

...
{if isset($_items)}
    {foreach from=$_items item="item"}
        {n8Maestro4_process_item item=$item module=$_conf.n8Maestro4_ft_1_list_type assign="_item"}
       <div class="col3">
           <div class="wrap">
               <div class="index_blog clearfix">
                   ...
                   {if $_item.module == 'jrAudio' || $_item.module == 'jrSoundCloud'}
                       <br>{jrCore_media_player type="jrAudio_button" module=$_conf.n8Maestro4_ft_1_list_type field="audio_file" item=$item}

...
<div class="page_nav">
    <div class="breadcrumbs">
        {n8Maestro4_breadcrumbs nav_mode="jrGroupDiscuss" profile_url=$item.profile_url page="detail" item=$item}
    </div>
            ...
            {if jrUser_is_logged_in()}
                <div class="action_feedback" style="padding: 0">
                    {if jrGroup_member_has_access($item)}
                        {n8Maestro4_feedback_buttons module="jrGroupDiscuss" item=$item}

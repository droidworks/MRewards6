...
<div class="col4">
    <div class="wrap">
        ...
        {n8Maestro4_process_item item=$item module=$_conf.n8Maestro4_ft_2_list_type assign="_item"}
        <div class="index_blog clearfix">
            ...
            {if $_item.module == 'jrAudio' || $_item.module == 'jrSoundCloud'}
              <br>{jrCore_media_player type="jrAudio_button" module=$_conf.n8Maestro4_ft_2_list_type field="audio_file" item=$item}

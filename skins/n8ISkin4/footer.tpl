...
<div class="footer">
    <div class="row">
        <div class="col12">
            <div class="social">
                <h2>{jrCore_lang id=33 skin="n8ISkin4" default="Visit Us on Social Media"}</h2>
                <ul class="social clearfix">
                    <li><a href="{$_conf.n8ISkin4_facebook_url}" class="social-facebook" target="_blank"></a></li>
                    <li><a href="{$_conf.n8ISkin4_twitter_url}" class="social-twitter" target="_blank"></a></li>
                    <li><a href="{$_conf.n8ISkin4_google_url}" class="social-google" target="_blank"></a></li>
                    <li><a href="{$_conf.n8ISkin4_linkedin_url}" class="social-linkedin" target="_blank"></a></li>
                    <li><a href="{$_conf.n8ISkin4_youtube_url}" class="social-youtube" target="_blank"></a></li>
                </ul>

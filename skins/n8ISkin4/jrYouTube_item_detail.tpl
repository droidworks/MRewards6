...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8ISkin4_breadcrumbs nav_mode="jrYouTube" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
    ...
    <div class="box">
        ...
        <div class="box_body">
            <div class="wrap detail_section">
                {jrYouTube_embed type="iframe" item_id=$item._item_id auto_play=$_conf.n8ISkin4_auto_play width="100%"}
                <div class="detail_box">
                    <div>
                        <div class="header">
                            <div>{jrCore_lang skin="n8ISkin4" id=41 default="Category"}</div>
                            <div>{jrCore_lang skin="n8ISkin4" id=45 default="Duration"}</div>
                            <div>{jrCore_lang skin="n8ISkin4" id=40 default="Created"}</div>
                            <div>{jrCore_lang skin="n8ISkin4" id=38 default="Plays"}</div>
                        </div>
                        <div class="details">
                ...
                <div class="action_feedback">
                    {n8ISkin4_feedback_buttons module="jrYouTube" item=$item}

<div class="col4 sidebar">
    ...
    <div class="page_nav">
        <div class="breadcrumbs">
            {n8ISkin4_breadcrumbs nav_mode="jrProfile" profile_url=$profile_url title=$profile_name}
        </div>
    </div>
    ...
    {if strlen($profile_bio) > 0}
        <div class="box">
            <ul class="head_tab">
                <li id="about_tab">
                    <a href="#" title="{jrCore_lang skin=$_conf.jrCore_active_skin id="12" default="About"} {$profile_name}"></a>
                </li>
            </ul>
            <div class="box_body">
                <div class="wrap">
    ...
    {if !jrCore_is_mobile_device() && isset($profile_influences) && strlen($profile_influences) > 0}
        <div class="box">
            <div class="head">{jrCore_lang skin=$_conf.jrCore_active_skin id="14" default="Influences"}</div>
            <div class="box_body">
                <div class="wrap">
                    <div class="media">
                        {$profile_influences}

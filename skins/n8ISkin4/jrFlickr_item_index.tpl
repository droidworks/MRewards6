...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        {n8ISkin4_breadcrumbs nav_mode="jrFlickr" profile_url=$profile_url profile_name=$profile_name page="index"}
    </div>
...
<div class="box">
    {n8ISkin4_sort template="sort_index.tpl" nav_mode="jrFlickr" profile_url=$profile_url}

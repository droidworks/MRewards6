...
{jrCore_lang module="pmPrivateAudio" id="71" default="play" assign="play"}
{jrCore_lang module="pmPrivateAudio" id="72" default="pause" assign="pause"}
...
{else}
    {assign var="play_i" value="`$jamroom_url`/`$murl`/img/module/pmPrivateAudio/button_player_play.png"}
    {assign var="play_h" value="`$jamroom_url`/`$murl`/img/module/pmPrivateAudio/button_player_play_hover.png"}
    {assign var="pause_i" value="`$jamroom_url`/`$murl`/img/module/pmPrivateAudio/button_player_pause.png"}
    {assign var="pause_h" value="`$jamroom_url`/`$murl`/img/module/pmPrivateAudio/button_player_pause_hover.png"}
{/if}

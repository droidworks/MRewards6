{jrCore_lang module="pmPrivateAudio" id=67 default="audio title" assign="ttl"}
{jrCore_lang module="pmPrivateAudio" id=14 default="audio file" assign="file_button"}
{jrCore_lang module="pmPrivateAudio" id=16 default="cover image" assign="image_button"}
<input type="text" id="audio_title" class="form_text" name="audio_title" value="" tabindex="1" placeholder="{$ttl|jrCore_entity_string}"><br>

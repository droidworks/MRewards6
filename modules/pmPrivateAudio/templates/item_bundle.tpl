        ...
        <div class="row">
            ...
            <div class="col5">
                <div class="p5" style="overflow-wrap:break-word">
                    ...
                    <span class="info">{jrCore_lang module="pmPrivateAudio" id="82" default="genre"}:</span> <span class="info_c">{$bundle_item.audio_genre}</span><br>
                    <span class="info">{jrCore_lang module="pmPrivateAudio" id="31" default="album"}:</span> <span class="info_c"><a href="{$jamroom_url}/{$bundle_item.profile_url}/{$murl}/albums/{$bundle_item.audio_album_url}">{$bundle_item.audio_album}</a></span>
                </div>
            </div>
            <div class="col2">
                <div class="p5">

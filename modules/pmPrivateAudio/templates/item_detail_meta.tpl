...
{jrCore_image module="pmPrivateAudio" image="facebook_player_skin.jpg" src_only=true assign="skin_url"}
...
{else}
<meta property="og:image" content="{$jamroom_url}/{jrCore_module_url module="jrImage"}/img/module/pmPrivateAudio/facebook_shared_icon.png" />
{/if}

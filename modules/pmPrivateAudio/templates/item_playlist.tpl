    ...
    <div id="a{$playlist_item._item_id}" class="item">
        <div class="container">
            <div class="row">
                <div class="col2">
                    <div class="p5">
                        <a href="{$jamroom_url}/{$playlist_item.profile_url}/{$murl}/{$playlist_item._item_id}/{$playlist_item.audio_title_url}">{jrCore_module_function function="jrImage_display" module="pmPrivateAudio" type="audio_image" item_id=$playlist_item._item_id size="small" crop="auto" class="iloutline" alt=$playlist_item.audio_title width=false height=false}</a>
                    </div>
                </div>
                <div class="col7">
                    <div class="p5">
                        ...
                        <span class="info">{jrCore_lang module="pmPrivateAudio" id="82" default="genre"}:</span> <span class="info_c">{$playlist_item.audio_genre}</span><br>
                        <span class="info">{jrCore_lang module="pmPrivateAudio" id="31" default="album"}:</span> <a href="{$jamroom_url}/{$playlist_item.profile_url}/{$murl}/albums/{$playlist_item.audio_album_url}"><span class="info_c">{$playlist_item.audio_album}</span></a>
                    </div>
                </div>
                <div class="col1">
                    <div class="p5">

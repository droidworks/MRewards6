        ...
        <div class="col12 last">
            <div class="p10">
                ...
                {if strlen($player_type) > 0}
                    {jrCore_media_player type=$player module="pmPrivateAudio" field="audio_file" item_id=$item._item_id autoplay=$autoplay}
                {else}
                    {jrCore_media_player module="pmPrivateAudio" field="audio_file" item_id=$item._item_id autoplay=$autoplay}
                {/if}

...
{if !isset($_post._2)}
    {jrCore_page_title title="`$profile_name` - {jrCore_lang module="pmPrivateAudio" id="41" default="Audio"}"}
    ...
    <div class="block">
        ...
        <div class="title">
            ...
            <h1>{jrCore_lang module="pmPrivateAudio" id="34" default="Albums"}</h1>
            <div class="breadcrumbs">
                ...
                {else}
                    <a href="{$jamroom_url}/{$profile_url}/{$murl}">{jrCore_lang module="pmPrivateAudio" id="41" default="Audio"}</a>
                {/if}
                &raquo; {jrCore_lang module="pmPrivateAudio" id="34" default="Albums"}
            </div>
        ...
        {capture name="row_template" assign="template"}
            {literal}
                ...
                <div class="item">
                    <a href="{$jamroom_url}/{$item.profile_url}/{$murl}/albums/{$item.audio_album_url}">{jrCore_module_function function="jrImage_display" module="pmPrivateAudio" type="audio_image" item_id=$item._item_id size="icon" crop="auto" alt=$item.audio_title title=$item.audio_title class="iloutline" width=false height=false}</a>
        ...
        <div class="block_content">
            ...
            {jrCore_list module="pmPrivateAudio" profile_id=$_profile_id order_by="_created desc" group_by="audio_album_url" pagebreak="6" page=$_post.p template=$template pager=true}
    ...
    <div class="block">
        ...
        <div class="title">
            ...
            <div class="breadcrumbs">
                ...
                {else}
                    <a href="{$jamroom_url}/{$_items.0.profile_url}/{$murl}">{jrCore_lang module="pmPrivateAudio" id="41" default="Audio"}</a>
                {/if}
                &raquo; <a href="{$jamroom_url}/{$_items.0.profile_url}/{$murl}/albums">{jrCore_lang module="pmPrivateAudio" id="34" default="Albums"}</a> &raquo; {$_items.0.audio_album}
            </div>
        ...
        <div class="block_content">
            ...
            <div class="item">
                ...
                <div class="center" style="padding:0;margin:0 auto;">
                    {jrCore_module_function function="jrImage_display" module="pmPrivateAudio" type="audio_image" item_id=$_items.0._item_id size="xxxlarge" crop="805:500" class="img_scale" alt=$_items.0.audio_title style="max-width:805px;max-height:500px;margin:0 auto;border-radius:0;"}
                </div>
                <br>
                {/if}
        ...
        <script type="text/javascript">
            $(function() {
                $('.sortable').sortable().bind('sortupdate', function(e,u) {
                    ...
                    $.post(core_system_url + '/' + pmPrivateAudio_url + "/order_update/__ajax=1", {
                        audio_file_track: o
                    });
                });
            });

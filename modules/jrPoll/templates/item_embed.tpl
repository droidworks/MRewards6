...
{if $smarty.now < $item.poll_end_date}
    <script type="text/javascript">
        $(document).ready(function () {
            $('span.countdown').each(function (index, element) {
                var n = Number($(this).text());
                cdown = new Date(n);
                if (typeof cdown != "undefined") {
                    $(this).countdown({ until: cdown });
                }
            });
        });
    </script>
                ...
                <div class="col12 last">
                    <div class="item">
                        ...
                        {if $smarty.now < $item.poll_start_date}
                            <div class="poll_open" style="width:200px;float:left;margin-right:12px">

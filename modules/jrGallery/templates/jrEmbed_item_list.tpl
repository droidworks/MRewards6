        ...
        <table class="page_table">
            <tr class="page_table_row">
                ...
                <td class="page_table_cell center" style="width:25%">
                    ...
                    <button class="form_button" onclick="jrGallery_toggle_aspect('{$aspect}')">{jrCore_lang module="jrGallery" id=53 default="Aspect"}</button>
                </td>
            </tr>

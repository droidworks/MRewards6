...
{if isset($_conf.kmParadigmDark_require_images) && $_conf.kmParadigmDark_require_images == 'on'}
    {jrCore_list module="jrProfile" order_by="_created desc" search1="profile_active = 1" quota_id=$_conf.kmParadigmDark_artist_quota template=$new_artists_template require_image="profile_image" pagebreak="6" page=$_post.p}
{else}
    {jrCore_list module="jrProfile" order_by="_created desc" search1="profile_active = 1" quota_id=$_conf.kmParadigmDark_artist_quota template=$new_artists_template pagebreak="6" page=$_post.p}
{/if}

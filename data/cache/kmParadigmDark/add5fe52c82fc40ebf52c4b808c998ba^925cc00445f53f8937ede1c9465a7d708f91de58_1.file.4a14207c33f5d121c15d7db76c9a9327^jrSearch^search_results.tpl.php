...
/* Smarty version 3.1.30, created on 2017-05-18 20:24:48
  from "/webserver/jamroom5/data/cache/jrCore/4a14207c33f5d121c15d7db76c9a9327^jrSearch^search_results.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_591e6580e3c5c8_21663330',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '925cc00445f53f8937ede1c9465a7d708f91de58' => 
    array (
      0 => '/webserver/jamroom5/data/cache/jrCore/4a14207c33f5d121c15d7db76c9a9327^jrSearch^search_results.tpl',
      1 => 1495164288,
      2 => 'file',
    ),
  ),
...
function content_591e6580e3c5c8_21663330 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_modifier_replace')) require_once '/webserver/jamroom5/modules/jrCore/contrib/smarty/libs/plugins/modifier.replace.php';
if (function_exists('smarty_function_jrCore_module_url')) { echo smarty_function_jrCore_module_url(array('module'=>"jrSearch",'assign'=>"murl"),$_smarty_tpl); } ?>
...
"><?php if (function_exists('smarty_function_jrCore_lang')) { echo smarty_function_jrCore_lang(array('module'=>"jrSearch",'id'=>"11",'default'=>"Home"),$_smarty_tpl); } ?></a> &raquo;
                        <a href="<?php echo $_smarty_tpl->tpl_vars['jamroom_url']->value;?>
...
"><?php if (function_exists('smarty_function_jrCore_lang')) { echo smarty_function_jrCore_lang(array('module'=>"jrSearch",'id'=>"6",'default'=>"All Search Results for"),$_smarty_tpl); } ?> &quot;<?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['search_string']->value,'&quot;','');?>
&quot;</a> &raquo; <?php echo $_smarty_tpl->tpl_vars['titles']->value[$_smarty_tpl->tpl_vars['modules']->value];?>

                    </div>
                <?php } else { ?>
                    <h1><?php if (function_exists('smarty_function_jrCore_lang')) { echo smarty_function_jrCore_lang(array('module'=>"jrSearch",'id'=>"8",'default'=>"Search Results for"),$_smarty_tpl); } ?> &quot;<?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['search_string']->value,"&quot;",'');?>
&quot;</h1>
                <?php }?>
...
/img/submit.gif" width="24" height="24" alt="<?php if (function_exists('smarty_function_jrCore_lang')) { echo smarty_function_jrCore_lang(array('module'=>"jrCore",'id'=>"73",'default'=>"working..."),$_smarty_tpl); } ?>"><input type="button" class="form_button" value="<?php if (function_exists('smarty_function_jrCore_lang')) { echo smarty_function_jrCore_lang(array('module'=>"jrSearch",'id'=>"7",'default'=>"search"),$_smarty_tpl); } ?> <?php echo $_smarty_tpl->tpl_vars['titles']->value[$_smarty_tpl->tpl_vars['modules']->value];?>
...
$__foreach_result_8_saved = $_smarty_tpl->tpl_vars['result'];
?>
...
/search_string=<?php echo $_smarty_tpl->tpl_vars['search_string']->value;?>
"><?php if (function_exists('smarty_function_jrCore_lang')) { echo smarty_function_jrCore_lang(array('module'=>"jrSearch",'id'=>"9",'default'=>"See All Results"),$_smarty_tpl); } ?> (<?php echo jrCore_number_format($_smarty_tpl->tpl_vars['info']->value[$_smarty_tpl->tpl_vars['module']->value]['total_items']);?>
) &raquo; </a>
                            <?php }?>
                            </div>
        ...
        <?php
$_smarty_tpl->tpl_vars['result'] = $__foreach_result_8_saved;
}
}
        ...
        <div class="row">
            <div class="col12 last">
                <div class="page_note" style="margin-bottom:12px">
                    <?php if (function_exists('smarty_function_jrCore_lang')) { echo smarty_function_jrCore_lang(array('module'=>"jrSearch",'id'=>"10",'default'=>"No results found for your search"),$_smarty_tpl); } ?>
                </div>
            </div>
        </div>

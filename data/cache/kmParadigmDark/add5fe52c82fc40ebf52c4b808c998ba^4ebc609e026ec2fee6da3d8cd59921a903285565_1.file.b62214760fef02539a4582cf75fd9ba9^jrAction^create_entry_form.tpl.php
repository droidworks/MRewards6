<?php
/* Smarty version 3.1.30, created on 2017-05-18 20:28:09
  from "/webserver/jamroom5/data/cache/jrCore/b62214760fef02539a4582cf75fd9ba9^jrAction^create_entry_form.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_591e6649d3edf1_17575697',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4ebc609e026ec2fee6da3d8cd59921a903285565' => 
    array (
      0 => '/webserver/jamroom5/data/cache/jrCore/b62214760fef02539a4582cf75fd9ba9^jrAction^create_entry_form.tpl',
      1 => 1495164489,
      2 => 'file',
    ),
  ),
...
function content_591e6649d3edf1_17575697 (Smarty_Internal_Template $_smarty_tpl) {
...
if (function_exists('smarty_function_jrCore_module_url')) { echo smarty_function_jrCore_module_url(array('module'=>"jrImage",'assign'=>"iurl"),$_smarty_tpl); } ?>
...
<?php if (function_exists('smarty_function_jrCore_lang')) { echo smarty_function_jrCore_lang(array('module'=>"jrAction",'id'=>3,'default'=>"Post a new Activity Update",'assign'=>"ph"),$_smarty_tpl); }
if (function_exists('smarty_function_jrCore_lang')) { echo smarty_function_jrCore_lang(array('module'=>"jrAction",'id'=>5,'default'=>"save update",'assign'=>"su"),$_smarty_tpl); } ?>
...
')"><?php if (function_exists('smarty_function_jrCore_icon')) { echo smarty_function_jrCore_icon(array('icon'=>$_smarty_tpl->tpl_vars['_t']->value['icon'],'size'=>30,'class'=>"sprite_icon_hilighted"),$_smarty_tpl); } ?></div>
            <?php } else { ?>
                <div class="quick_action_tab" title="<?php echo jrCore_entity_string($_smarty_tpl->tpl_vars['_t']->value['title']);?>
" onclick="jrAction_quick_share(this, '<?php echo $_smarty_tpl->tpl_vars['_t']->value['module'];?>
','<?php echo $_smarty_tpl->tpl_vars['_t']->value['function'];?>
')"><?php if (function_exists('smarty_function_jrCore_icon')) { echo smarty_function_jrCore_icon(array('icon'=>$_smarty_tpl->tpl_vars['_t']->value['icon'],'size'=>30),$_smarty_tpl); } ?></div>
            <?php }?>
        <?php
}
}
...
/form_spinner.gif" width="24" height="24" alt="<?php if (function_exists('smarty_function_jrCore_lang')) { echo smarty_function_jrCore_lang(array('module'=>"jrCore",'id'=>73,'default'=>"working..."),$_smarty_tpl); } ?>" style="display:none">

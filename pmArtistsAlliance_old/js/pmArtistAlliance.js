 ...
 */
function pmArtistsAlliance_notification_option(v)
{
 ...
 */
function pmArtistsAlliance_delete_user(u, p)
{
 ...
 * Delete a user
 */
function pmArtistsAlliance_delete_user_from_modal()
{
    var i = $('#user-delete-active-user-id').text();
    var u = core_system_url + '/' + pmArtistsAlliance_url + '/delete_save/id=' + Number(i);
 ...
 * Delete a profile
 */
function pmArtistsAlliance_delete_profile_from_modal()
{
